    ...
    private View createView(MetaClass meta) {
        ...
        for (MetaProperty metaProperty : meta.getProperties()) {
            ...
            switch (metaProperty.getType()) {
                ...
                case ASSOCIATION:
                case COMPOSITION:
                    String viewName = metaProperty.getRange().getCardinality().isMany() ? View.LOCAL
                            : isEmbedded(metaProperty) ? View.LOCAL : View.MINIMAL;
                    ...
                    view.addProperty(metaProperty.getName(), propView, !isEmbedded(metaProperty));
                    break;
                default:
