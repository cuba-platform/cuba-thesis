...
public class CommonLookupController extends AbstractLookup {
    ...
    public void init(Map<String, Object> params) {
        super.init(params);
        getDialogParams()
                .setWidth(themeConstantsManager.getThemeValueInt("cuba.gui.commonLookup.width"))
    ...
    protected void initView() {
        ...
        view = new View(localView, null, false);
        for (ViewProperty property : minimalView.getProperties()) {
            if (!view.containsProperty(property.getName())) {
                view.addProperty(property.getName(), property.getView(), property.isLazy());
            }
        }
    }
}